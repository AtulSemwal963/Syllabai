      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4 md:space-y-0 md:space-x-4">
            <Link href="/dashboard" >
            <Button className="w-5/6 md:w-1/4 font-bold group/arrow" style={{backgroundColor:"#007FFF"}}>
              Get Started
        ...
        <div className="relative group mt-14">
          <div className="absolute top-2 lg:-top-8 left-1/2 transform -translate-x-1/2 w-[90%] mx-auto h-24 lg:h-80  rounded-full blur-3xl" style={{backgroundColor:"#007FFF"}}></div>
          <Image
            width={1200}
            height={1200}
